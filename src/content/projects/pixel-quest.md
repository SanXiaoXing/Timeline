...
milestones:
  - id: "m1"
    label: "立项"
    pct: 10
    description: "确定任务板信息结构：任务、阶段、奖励与状态。"
  - id: "m2"
    label: "UI 组件"
    pct: 25
    description: "完成任务卡片、筛选、标签与 HUD 头部组件。"
  - id: "m3"
    label: "动效系统"
    pct: 40
    description: "统一进入/切换/数值变化动效节奏，建立动效基线。"
  - id: "m4"
    label: "数据驱动"
    pct: 60
    description: "任务来自 TS/JSON，支持状态与筛选联动。"
  - id: "m5"
    label: "发布"
    pct: 100
    description: "打磨交互与可读性，完成发布版本。"
timeline:
  - id: "t1"
    milestoneId: "m1"
    title: "任务接取：像素任务板"
...
像素风格的任务管理面板，带有游戏化体验。当前处于暂停状态，等待后续的优化和打磨。
